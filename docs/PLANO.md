...
- **Assinatura Authenticode do `.exe`** — depende de um serviço externo (SignPath Foundation, gratuito para código aberto) ou de comprar um certificado. Ver `docs/VERIFICAR-ASSINATURA.md` para a assinatura GPG já existente, que é diferente disso.
