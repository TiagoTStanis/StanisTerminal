...
Também há a versão de arquivo único **StanisTerminal-1.1.0-win-x64.exe**. Ela extrai os componentes antes de abrir e pode levar cerca de um minuto nesta máquina. Deixe o programa em uma pasta sua, como Documentos, com espaço livre e permissão de escrita.
